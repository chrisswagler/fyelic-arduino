/*
   ...
   by Chris Swagler
   purpose: to use the flame sensor to light an LED when a flame is detected,
            and otherwise display the value sensed

   Note: the potentiometer on the module can be used to adjust sensitivity
*/
