/*
   modified 12 Feb 2022
   by Chris Swagler
   purpose: to use the Neopixel Library to display color patterns on an RGB LED strip

   Note: the Neopixel library was used to control the LED strip.
