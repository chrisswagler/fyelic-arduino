/***************************
 * Example Sketch for the SparkFun MEMS Microphone Breakout Board (ADMP401)
 * Written by jenfoxbot <jenfoxbot@gmail.com>
 * modified 19 March 2021
 * by Chris Swagler
 * purpose: to use the ADMP401 microphone to read the peak to peak amplitude of a 
 *          sound signal and produce a volume unit 0 to 10
 */
